...
export default function HomePage() {
  return (
<div className=" flex items-center justify-center flex-col px-5 md:px-10 lg:px-20">
{/* First Section */}
<div>
  <motion.div
  ...
  >
    <div className="text-left my-30 px-20 py-10 w-1/2">
      <div>
      ...
      <motion.div
        ...
        className="flex flex-row items-start py-3"
      >
        <div className="mb-3">
          <motion.div
            className="w-55"
  ...
  <motion.div className="flex justify-center py-10" variants={itemVariants}>
